...
public class RegistrationIntentService extends IntentService {
    ...
    private void sendRegistrationToServer(String token) {
        ...
        Log.d(TAG, "Sending Token to Lambda :: " + token);
//        AmazonSNSClient pushClient = new AmazonSNSClient(CredentialHolder.getInstance().getCredentialHolder());
...
//        platformEndpointRequest.setPlatformApplicationArn(getApplicationContext().getString(R.string.endpoint_arn_sns));
